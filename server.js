...
app.post('/extract-from-resume', async (req, res) => {
  try {
    ...
    // 初始化OpenAI
    const openaiConfig = {
      apiKey: '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',
    };
